...
<html lang="es">
  <head>
    <title>EDgrid | Banner</title>
    <meta charset="utf-8">
    <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="Componente banner creado con el prototipado de EDgrid.">
    <!-- Estilos-->
    ...
    <meta property="og:title" content="EDgrid | Banner">
    <meta property="og:type" content="website">
    <meta property="og:description" content="Componente banner creado con el prototipado de EDgrid.">
    <meta property="og:url" content="/banner.html">
    ...
    <meta property="twitter:title" content="EDgrid | Banner">
    <meta property="twitter:site" content="@EDteamLat">
    <meta property="twitter:description" content="Componente banner creado con el prototipado de EDgrid.">
  ...
  <body itemscope itemtype="http://schema.org/WebPage">
    ...
    <!-- Banner section-->
    <section class="main-banner background grey-800 l-section">
      <div class="ed-grid lg-grid-2 row-gap s-gap-2 m-gap-4">
        <div class="s-column s-main-center lg-main-start lg-cross-start s-center lg-left">
          <h1 class="bigger-title"><span class="color white-color">Banner principal <br/> <span class="color blue-400">de dos columnas</span> <br/> con EDgrid</span></h1>
          <p class="white-color s-opacity-8">Creado utilizando los componentes de columnas. Totalmente responsive.</p>
          <div class="s-main-center"><a class="button blue-500 s-mr-2 s-mb-2 m-mb-0">Botón 1</a><a class="button ghost blue-400 s-mb-2 m-mb-0">Botón 2</a></div>
        </div>
        <div>
          <div class="img-container s-ratio-16-9"><img class="s-radius-1" src="/assets/img/og-image.jpg"></div>
        </div>
      </div>
    </section>
    <!-- Main-->
    ...
    <div class="ed-grid cols-l-4 main-section l-big-section">
      ...
      <div class="span-l-3">
        <main itemscope itemprop="mainContentOfPage" role="main"><h2>Banner de dos columnas</h2>
