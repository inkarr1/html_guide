...
<html lang="es">
  <head>
    <title>EDgrid | Visibilidad</title>
    <meta charset="utf-8">
    <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="El componente visibilidad permite definir los breakpoints en los que un elemento se mostrará y los breakpoints en los que se ocultará. Uso con CSS (cssHelpers) Use las clases from-bp o to-bp donde bp es un breakpoint válido de ed-grid (s,m,l,xl) from-bp hará al elemento visible a partir del breakpoint especificado e invisible por debajo de él. to-bp hará al elemento visible por debajo del breakpoint especificado e invisible por encima de él.">
    <!-- Estilos-->
    ...
    <meta property="og:title" content="EDgrid | Visibilidad">
    <meta property="og:type" content="website">
    <meta property="og:description" content="El componente visibilidad permite definir los breakpoints en los que un elemento se mostrará y los breakpoints en los que se ocultará. Uso con CSS (cssHelpers) Use las clases from-bp o to-bp donde bp es un breakpoint válido de ed-grid (s,m,l,xl) from-bp hará al elemento visible a partir del breakpoint especificado e invisible por debajo de él. to-bp hará al elemento visible por debajo del breakpoint especificado e invisible por encima de él.">
    <meta property="og:url" content="/visibilidad.html">
    ...
    <meta property="twitter:title" content="EDgrid | Visibilidad">
    <meta property="twitter:site" content="@EDteamLat">
    <meta property="twitter:description" content="El componente visibilidad permite definir los breakpoints en los que un elemento se mostrará y los breakpoints en los que se ocultará. Uso con CSS (cssHelpers) Use las clases from-bp o to-bp donde bp es un breakpoint válido de ed-grid (s,m,l,xl) from-bp hará al elemento visible a partir del breakpoint especificado e invisible por debajo de él. to-bp hará al elemento visible por debajo del breakpoint especificado e invisible por encima de él.">
  ...
  <body itemscope itemtype="http://schema.org/WebPage">
    ...
    <div class="ed-grid cols-l-4 main-section l-big-section">
      ...
      <div class="span-l-3">
        <main itemscope itemprop="mainContentOfPage" role="main"><h1>Visibilidad</h1>
