...
<html lang="es">
  <head>
    <title>EDgrid | Documentación</title>
    <meta charset="utf-8">
    <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="Puede usar EDgrid con CSS y Sass.">
    <!-- Estilos-->
    ...
    <meta property="og:title" content="EDgrid | Documentación">
    <meta property="og:type" content="website">
    <meta property="og:description" content="Puede usar EDgrid con CSS y Sass.">
    <meta property="og:url" content="/documentacion">
    ...
    <meta property="twitter:title" content="EDgrid | Documentación">
    <meta property="twitter:site" content="@EDteamLat">
    <meta property="twitter:description" content="Puede usar EDgrid con CSS y Sass.">
  ...
  <body itemscope itemtype="http://schema.org/WebPage">
    ...
    <!-- Banner section-->
    <div class="main-banner background s-py-4 grey-700 l-block img-container dark-color">
      <div class="ed-grid lg-grid-6">
        <div class="lg-cols-4 lg-x-2 s-center">
          <div class="main-banner__data">
            <div class="t1 s-mb-2"><span class="color white-color">Documentación</span></div>
            <p class="color white-color s-opacity-8 s-mb-0">EDgrid es muy fácil de aprender. En una hora ya lo estará usando en sus proyectos</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="ed-grid cols-l-4 main-section l-big-section">
      ...
      <div class="span-l-3">
        <main itemscope itemprop="mainContentOfPage" role="main"><h1>Comenzar con EDgrid</h1>
