...
<html lang="es">
  <head>
    <title>EDgrid | Modo dev</title>
    <meta charset="utf-8">
    <meta name="viewport" content="initial-scale=1.0, width=device-width">
    <meta name="description" content="El modo dev (modo desarrollo en versiones anteriores) es una característica exclusiva de ed-grid (no existente en otros frameworks) que nos permite saber el breakpoint actual y los componentes del layout (ed-container y ed-item). Al activarlo el navegador muestra el layout de la siguiente manera: En la parte superior en una franja azul se muestra el breakpoint actual y la leyenda de colores para el ed-container y los ed-item. El layout de la página es coloreado de la siguiente manera:">
    <!-- Estilos-->
    ...
    <meta property="og:title" content="EDgrid | Modo dev">
    <meta property="og:type" content="website">
    <meta property="og:description" content="El modo dev (modo desarrollo en versiones anteriores) es una característica exclusiva de ed-grid (no existente en otros frameworks) que nos permite saber el breakpoint actual y los componentes del layout (ed-container y ed-item). Al activarlo el navegador muestra el layout de la siguiente manera: En la parte superior en una franja azul se muestra el breakpoint actual y la leyenda de colores para el ed-container y los ed-item. El layout de la página es coloreado de la siguiente manera:">
    <meta property="og:url" content="/modo-dev.html">
    ...
    <meta property="twitter:title" content="EDgrid | Modo dev">
    <meta property="twitter:site" content="@EDteamLat">
    <meta property="twitter:description" content="El modo dev (modo desarrollo en versiones anteriores) es una característica exclusiva de ed-grid (no existente en otros frameworks) que nos permite saber el breakpoint actual y los componentes del layout (ed-container y ed-item). Al activarlo el navegador muestra el layout de la siguiente manera: En la parte superior en una franja azul se muestra el breakpoint actual y la leyenda de colores para el ed-container y los ed-item. El layout de la página es coloreado de la siguiente manera:">
  ...
  <body itemscope itemtype="http://schema.org/WebPage">
    ...
    <div class="ed-grid cols-l-4 main-section l-big-section">
      ...
      <div class="span-l-3">
        <main itemscope itemprop="mainContentOfPage" role="main"><h1>Modo dev</h1>
